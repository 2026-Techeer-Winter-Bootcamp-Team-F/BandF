...
from .views import CardRecommendationView, CardBenefitAnalysisView, CardListView, CardRecommendationsView  # [설명] 카드 관련 뷰 import
...
urlpatterns = [
    ...
    path('recommendations/', CardRecommendationsView.as_view(), name='card_recommendations'),  # [설명] 카테고리별 카드 추천 엔드포인트
]
